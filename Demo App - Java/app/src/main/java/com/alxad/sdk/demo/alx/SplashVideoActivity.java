...
public class SplashVideoActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = "AlxSplashVideoActivity";
    ...
    private void initView() {
        ...
        setAdInfo(AdConfig.ALX_SPLASH_VIDEO_AD_ID);
    }
    ...
    public void loadAd() {
        ...
        mSplashAd.load(this, AdConfig.ALX_SPLASH_VIDEO_AD_ID, builder.build(), new AlxSplashAdListener() {
