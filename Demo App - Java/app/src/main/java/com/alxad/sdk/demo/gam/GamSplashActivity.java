...
public class GamSplashActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG = "GamSplashActivity";
    ...
    private void bnLoad() {
        ...
        AdRequest adRequest = new AdManagerAdRequest.Builder()
                .build();
        AppOpenAd.load(this, AdConfig.GAM_SPLASH_ID, adRequest,
