...
public class AdmobSplashActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG = "AdmobSplashActivity";
    ...
    private void bnLoad() {
        ...
        AdRequest adRequest = new AdRequest.Builder()
                .build();
        AppOpenAd.load(this, AdConfig.ADMOB_SPLASH_ID, adRequest,
