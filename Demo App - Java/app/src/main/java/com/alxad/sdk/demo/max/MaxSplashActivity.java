...
public class MaxSplashActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = "MaxSplashActivity";
    ...
    private MaxAppOpenAd mAdObject;
    ...
    private void loadAd() {
        ...
        mAdObject = new MaxAppOpenAd(AdConfig.MAX_SPLASH_AD,this);
    ...
    private final MaxAdListener mMaxAdListener = new MaxAdListener() {
