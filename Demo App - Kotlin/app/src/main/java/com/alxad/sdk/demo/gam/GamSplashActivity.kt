...
class GamSplashActivity : BaseActivity(), View.OnClickListener {
    override val TAG = "GamSplashActivity"
    ...
    fun bnLoad() {
        ...
        AppOpenAd.load(
            this, AdConfig.GAM_SPLASH_ID, adRequest,
