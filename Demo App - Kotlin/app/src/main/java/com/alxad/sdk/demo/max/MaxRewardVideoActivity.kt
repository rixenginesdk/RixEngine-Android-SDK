...
class MaxRewardVideoActivity : BaseActivity(), View.OnClickListener {

    override val TAG = "MaxRewardVideoActivity"
    private var mTvTip: TextView? = null
    private var mTvShow: TextView? = null
    private var startTime: Long = 0
    private var mAdObject: MaxRewardedAd? = null
    ...
    private val mMaxRewardedAdListener: MaxRewardedAdListener = object : MaxRewardedAdListener {
        ...
        override fun onUserRewarded(ad: MaxAd, reward: MaxReward) {
            Log.d(TAG, "onUserRewarded:" + reward.label)
        }
    }
}