...
class AdmobNativeActivity : BaseActivity(), View.OnClickListener {
    override val TAG = "AdmobNativeActivity"
    ...
    private fun loadAd() {
        ...
        mAdLoader = AdLoader.Builder(this, AdConfig.ADMOB_NATIVE_ID)
